...
<@layout.registrationLayout displayMessage=!messagesPerField.existsError('username','password') displayInfo=realm.password && realm.registrationAllowed && !registrationDisabled??; section>
    <#if section = "header">
        <span id="tb-login-title">${msg("loginAccountTitle")}</span>
        <div id="tb-login-subtitle" style="font-size:13px;font-weight:400;color:#626262;margin-top:4px;display:none;"></div>
    <#elseif section = "form">
        <div id="kc-form">
