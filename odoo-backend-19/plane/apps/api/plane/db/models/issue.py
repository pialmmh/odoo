...
class IssueRelation(ProjectBaseModel):
    ...
    class Meta:
        ...
        db_table = "plane_issue_relations"
        ordering = ("-created_at",)
...
class IssueAssignee(ProjectBaseModel):
    ...
    class Meta:
        ...
        db_table = "plane_issue_assignees"
        ordering = ("-created_at",)
...
class IssueAttachment(ProjectBaseModel):
    ...
    class Meta:
        ...
        db_table = "plane_issue_attachments"
        ordering = ("-created_at",)
...
class IssueActivity(ProjectBaseModel):
    ...
    class Meta:
        ...
        db_table = "plane_issue_activities"
        ordering = ("-created_at",)
...
class IssueSequence(ProjectBaseModel):
    ...
    class Meta:
        ...
        db_table = "plane_issue_sequences"
        ordering = ("-created_at",)
...
class IssueSubscriber(ProjectBaseModel):
    ...
    class Meta:
        ...
        db_table = "plane_issue_subscribers"
        ordering = ("-created_at",)
...
class IssueReaction(ProjectBaseModel):
    ...
    class Meta:
        ...
        db_table = "plane_issue_reactions"
        ordering = ("-created_at",)
...
class CommentReaction(ProjectBaseModel):
    ...
    class Meta:
        ...
        db_table = "plane_comment_reactions"
        ordering = ("-created_at",)
...
class IssueDescriptionVersion(ProjectBaseModel):
    ...
    class Meta:
        ...
        db_table = "plane_issue_description_versions"
