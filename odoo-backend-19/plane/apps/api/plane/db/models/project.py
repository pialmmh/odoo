...
class ProjectMemberInvite(ProjectBaseModel):
    ...
    class Meta:
        ...
        db_table = "plane_project_member_invites"
        ordering = ("-created_at",)
...
class ProjectMember(ProjectBaseModel):
    ...
    class Meta:
        ...
        db_table = "plane_project_members"
        ordering = ("-created_at",)
...
class ProjectIdentifier(AuditModel):
    ...
    class Meta:
        ...
        db_table = "plane_project_identifiers"
        ordering = ("-created_at",)
...
class ProjectDeployBoard(ProjectBaseModel):
    ...
    class Meta:
        ...
        db_table = "plane_project_deploy_boards"
        ordering = ("-created_at",)
...
class ProjectPublicMember(ProjectBaseModel):
    ...
    class Meta:
        ...
        db_table = "plane_project_public_members"
        ordering = ("-created_at",)
...
class ProjectUserProperty(ProjectBaseModel):
    ...
    class Meta:
        ...
        db_table = "plane_project_user_properties"
        ordering = ("-created_at",)
