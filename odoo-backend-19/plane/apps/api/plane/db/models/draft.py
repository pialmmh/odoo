...
class DraftIssueAssignee(WorkspaceBaseModel):
    ...
    class Meta:
        ...
        db_table = "plane_draft_issue_assignees"
        ordering = ("-created_at",)
...
class DraftIssueLabel(WorkspaceBaseModel):
    ...
    class Meta:
        ...
        db_table = "plane_draft_issue_labels"
        ordering = ("-created_at",)
...
class DraftIssueModule(WorkspaceBaseModel):
    ...
    class Meta:
        ...
        db_table = "plane_draft_issue_modules"
        ordering = ("-created_at",)
...
class DraftIssueCycle(WorkspaceBaseModel):
    ...
    class Meta:
        ...
        db_table = "plane_draft_issue_cycles"
        ordering = ("-created_at",)
