...
class WorkspaceMember(BaseModel):
    ...
    class Meta:
        ...
        db_table = "plane_workspace_members"
        ordering = ("-created_at",)
...
class WorkspaceMemberInvite(BaseModel):
    ...
    class Meta:
        ...
        db_table = "plane_workspace_member_invites"
        ordering = ("-created_at",)
...
class WorkspaceTheme(BaseModel):
    ...
    class Meta:
        ...
        db_table = "plane_workspace_themes"
        ordering = ("-created_at",)
...
class WorkspaceUserProperties(BaseModel):
    ...
    class Meta:
        ...
        db_table = "plane_workspace_user_properties"
        ordering = ("-created_at",)
...
class WorkspaceUserLink(WorkspaceBaseModel):
    ...
    class Meta:
        ...
        db_table = "plane_workspace_user_links"
        ordering = ("-created_at",)
...
class WorkspaceHomePreference(BaseModel):
    ...
    class Meta:
        ...
        db_table = "plane_workspace_home_preferences"
        ordering = ("-created_at",)
...
class WorkspaceUserPreference(BaseModel):
    ...
    class Meta:
        ...
        db_table = "plane_workspace_user_preferences"
        ordering = ("-created_at",)
