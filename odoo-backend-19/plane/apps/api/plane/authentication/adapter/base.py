...
class Adapter:
    ...
    def sanitize_email(self, email):
        ...
        # When Odoo-backed auth is on, the "email" field actually carries the
        # Odoo `res.users.login` (which can be a username like 'admin', not an
        # RFC 5321 address). Skip format validation so usernames are accepted.
