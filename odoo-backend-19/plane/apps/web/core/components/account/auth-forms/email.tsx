...
export const AuthEmailForm = observer(function AuthEmailForm(props: TAuthEmailForm) {
  ...
  // When Odoo-backed auth is wired into the API, the backend accepts both
  // an Odoo res.users.login (e.g. "admin") and an email — so we don't gate
  // the form on email format. Server-side check is the source of truth.
      ...
      <div className="space-y-1">
        ...
        >
          <Input
            ...
            placeholder="Email or Odoo username"
