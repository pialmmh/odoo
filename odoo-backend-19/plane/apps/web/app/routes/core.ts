  ...
  layout("./(all)/layout.tsx", [
    ...
    layout("./(all)/[workspaceSlug]/layout.tsx", [
      ...
      layout("./(all)/[workspaceSlug]/(projects)/layout.tsx", [
        ...
        // Chat (full-page Rocket.Chat-style surface)
        ...
        // CRM — Leads (data via Spring Boot gateway → Odoo crm.lead)
        layout("./(all)/[workspaceSlug]/(projects)/crm/leads/layout.tsx", [
          route(":workspaceSlug/crm/leads", "./(all)/[workspaceSlug]/(projects)/crm/leads/page.tsx"),
        ]),
        layout("./(all)/[workspaceSlug]/(projects)/crm/leads/[leadId]/layout.tsx", [
          route(
            ":workspaceSlug/crm/leads/:leadId",
            "./(all)/[workspaceSlug]/(projects)/crm/leads/[leadId]/page.tsx"
          ),
        ]),

        // Orchestrix — placeholder root for the gradual migration of orchestrix-ui
        // infra management into Plane. Subsections (containers, networking, etc.)
        // will be added underneath as separate routes.
        layout("./(all)/[workspaceSlug]/(projects)/orchestrix/layout.tsx", [
          route(":workspaceSlug/orchestrix", "./(all)/[workspaceSlug]/(projects)/orchestrix/page.tsx"),
        ]),

        // Discuss — minimal native chat over Odoo discuss.channel + mail.message
        layout("./(all)/[workspaceSlug]/(projects)/discuss/layout.tsx", [
          route(":workspaceSlug/discuss", "./(all)/[workspaceSlug]/(projects)/discuss/page.tsx"),
        ]),
